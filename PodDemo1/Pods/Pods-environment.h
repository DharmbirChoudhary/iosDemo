...
// HockeyKit
#define COCOAPODS_POD_AVAILABLE_HockeyKit
#define COCOAPODS_VERSION_MAJOR_HockeyKit 2
#define COCOAPODS_VERSION_MINOR_HockeyKit 0
#define COCOAPODS_VERSION_PATCH_HockeyKit 7
